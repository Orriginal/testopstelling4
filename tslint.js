...
module.exports = {
    'extends': ['tslint:recommended', "tslint-stencil/default"],
...
// https://github.com/palantir/tslint/blob/2b8a7374cf0fa28e85d95beb40aafd7cb011d157/src/configs/recommended.ts#L18-L204)
        ...
        'whitespace': {
            'options': ['check-branch', 'check-decl', 'check-operator', 'check-module', 'check-separator', 'check-rest-spread', 'check-type', 'check-type-operator', 'check-preblock']
        },
// Added rules
